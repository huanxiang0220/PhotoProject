...
public class ThemeConfig implements Serializable{
    ...
    public static class Builder {
        ...
        private int titleBarBgColor = Color.rgb(0x15, 0x88, 0xee);
        private int titleBarIconColor = Color.WHITE;
        private int checkNornalColor = Color.rgb(0x3F, 0x51, 0xB5);
        private int checkSelectedColor = Color.rgb(0x3F, 0x51, 0xB5);
        private int fabNornalColor = Color.rgb(0x15, 0x88, 0xee);
        private int fabPressedColor = Color.rgb(0x30, 0x3f, 0x9f);
        private int cropControlColor = Color.rgb(0x15, 0x88, 0xee);

        private int iconBack = R.drawable.gf_back;
        private int iconCamera = R.drawable.gf_camera;
        private int iconCrop = R.drawable.gf_crop;
        private int iconRotate = R.drawable.gf_rotate;
        private int iconClear = R.drawable.gf_clear;
        private int iconFolderArrow = R.drawable.gf_triangle_arrow;
        private int iconDelete = R.drawable.gf_delete_photo;
        private int iconCheck = R.drawable.ic_folder_check;
        private int iconFab = R.drawable.ic_folder_check;
        private int iconPreview = R.drawable.gf_ic_preview;
