...
import cn.finalteam.galleryfinal.adapter.PicassoImageLoader;
...
public class CoreConfig {
	 ...
	 * 保存图片的本地路径
	 */
	public static final String STORE_LOCAL_IMAGE_PATH = Environment.getExternalStorageDirectory()+ "/Ifcnt/Picture/";
    ...
    private CoreConfig(Builder builder) {
        ...
        if ( takePhotoFolder == null ) {
            takePhotoFolder = new File(STORE_LOCAL_IMAGE_PATH);
        }
        ...
        if ( editPhotoCacheFolder == null ) {
            editPhotoCacheFolder = new File(STORE_LOCAL_IMAGE_PATH);
        }
    ...
    public static class Builder {
        ...
        private AbsListView.OnScrollListener onScrollListener;
        private PicassoImageLoader picassoImageLoader = new PicassoImageLoader();

        public Builder(Context context, ThemeConfig themeConfig) {
