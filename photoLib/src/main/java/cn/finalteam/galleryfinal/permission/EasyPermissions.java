...
/**
 * Desction:Utility to request and check System permissions for apps targeting
 * Android M (API >= 23). Author:pengjianbo Date:16/1/24 下午11:31
 */
					...
					.setNegativeButton(negativeButton,
							new DialogInterface.OnClickListener() {
								...
								public void onClick(DialogInterface dialog,
									...
									if (callbacks != null) {
										callbacks
												.onPermissionsDenied(new ArrayList<String>());
									}
								}
							}).create();
			dialog.show();
