...
//            View view = findViewById(R.id.root_view_select_photo);
//            if(view != null){
//              StatuBar.setTranslucentStatus(PhotoSelectActivity.this, view);
//            }
            ...
            if (GalleryFinal.getFunctionConfig().isMutiSelect()) {
                ...
                mFabOk.setVisibility(View.GONE);
			}
...
//        }
        ...
        if (GalleryFinal.getGalleryTheme().getIconFolderArrow() == R.drawable.gf_triangle_arrow) {
        ...
        if (GalleryFinal.getGalleryTheme().getIconClear() == R.drawable.gf_clear) {
    ...
    private void photoItemClick(View view, int position) {
        ...
        if (!GalleryFinal.getFunctionConfig().isMutiSelect()) {
            ...
            String ext =ImageUtils.getExtension(info.getPhotoPath());
     ...
     * 获取所有图片
     */
    @SuppressLint("InlinedApi") @AfterPermissionGranted(GalleryFinal.PERMISSIONS_CODE_GALLERY)
    private void requestGalleryPermission() {
        if (EasyPermissions.hasPermissions(this, Manifest.permission.READ_EXTERNAL_STORAGE)) {
            getPhotos();
        } else {
            // Ask for one permission
            EasyPermissions.requestPermissions(this, getString(R.string.permissions_tips_gallery),GalleryFinal.PERMISSIONS_CODE_GALLERY, Manifest.permission.READ_EXTERNAL_STORAGE);
        }
    }
