...
import cn.finalteam.galleryfinal.utils.GalleryDialog;
...
//		String message1 = "hgsjkhfvjkshik";
//		ProgressDialog dialog = ProgressDialog.show(activity, title, message1,true, false);
		GalleryDialog dialog = new GalleryDialog(activity);
	...
	private static class BackgroundJob extends
		...
		private final GalleryDialog dialog;
		...
		public BackgroundJob(MonitoredActivity activity, Runnable job,GalleryDialog dialog, Handler handler) {
